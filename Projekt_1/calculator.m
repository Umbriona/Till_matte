...
% Last Modified by GUIDE v2.5 22-May-2013 10:22:37
...
% --- Executes on button press in Fraktorial.
function Fraktorial_Callback(hObject, eventdata, handles)
% hObject    handle to Fraktorial (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clc

H = get(handles.Text,'string');
h = str2double(H);
f=1;
for i=1:h
    f=f*i;
